...
-- /___/   /\     Timestamp: Sun Mar 21 19:10:09 2021
-- \   \  /  \ 
--  \___\/\___\
--             
...
-- Input file	: top.ncd
-- Output file	: C:\Users\rober\OneDrive\Desktop\Labs_CSO\AddSub4V\netgen\par\top_timesim.vhd
-- # of Entities	: 1
-- Design Name	: top
-- Xilinx	: C:\Xilinx92i
--             
...
architecture Structure of top is
  ...
  signal XLXI_3_Madd_R_cy_0_Q : STD_LOGIC; 
  ...
  signal XLXI_3_Madd_R_cy_2_Q : STD_LOGIC; 
  signal N8 : STD_LOGIC; 
...
begin
  ...
  R_2_OBUF_XORG : X_XOR2
    ...
    port map (
      I0 => XLXI_3_Madd_R_cy_2_Q,
      I1 => N8,
      O => R_2_OBUF_XORG_21
    );
  XLXI_3_Madd_R_lut_3_Q : X_LUT4
    generic map(
      INIT => X"9696",
      LOC => "SLICE_X54Y11"
    )
